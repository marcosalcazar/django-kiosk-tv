# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2017-04-22 22:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('feed_interval', models.PositiveSmallIntegerField(blank=True, help_text='Tiempo de espera para automáticamente mover al siguiente item', null=True, verbose_name='Intervalo')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.PositiveIntegerField(db_index=True, editable=False)),
                ('name', models.CharField(max_length=255, verbose_name='Nombre')),
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='childs', to='walltv.GenericRow', verbose_name='Padre')),
            ],
            options={
                'verbose_name': 'Fila',
                'ordering': ('order',),
